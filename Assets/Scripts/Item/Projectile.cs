...
public class Projectile : MonoBehaviour
{
    ...
    public void Set(int index, float speed, float damage, float distance, Transform parentTransform, Vector3 direction, Sprite sprite)
    {
        ...
        this.speed = speed;
        this.damage = damage;
        this.startPoint = parentTransform.position;
        ...
        gameObject.transform.rotation = Quaternion.Euler(0, 0, Mathf.Atan2(direction.y, direction.x) * Mathf.Rad2Deg - 30f + parentTransform.rotation.eulerAngles.z);
